...
class Cordinating extends React.Component {
  onMaosWheelHandler=({ctrlKey,wheelUpDirection})=>{
    this.props.onMaosWheel({
      ctrlKey,wheelUpDirection
    });
  }


  render() {
    const { timeline, routeTable,sortTaiXe,choseCustomer,cordinating,chuyentrai,choseCustomerCtrl} = this.props;
    // console.log("......................1",choseCustomerCtrl)
    return (
      <div>
        <div>
          <CordinatingHeader sortTaiXe = {sortTaiXe} chuyentrai={chuyentrai} choseCustomerCtrl={choseCustomerCtrl}  />
        </div>
        <div className="cordinating_body">
          ...
          <div className="timeline-underlying">
            ...
            <Timeline style={timeline.style} data={timeline.data} cordinating ={cordinating} />
          </div>
        </div>
      </div>
    );
