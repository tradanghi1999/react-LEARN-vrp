...
class RouteTable extends React.Component {
  ...
  Routes = () => {
    ...
    const { style, data ,choseCustomer,cordinating,choseCustomerCtrl } = this.props;
    console.log("routeTb",choseCustomer);
    console.log("....................",choseCustomerCtrl);
    Routes = data.map((x, i) => {
      let st = {
      ...
      return <RouteRow key={i + 1} style={st} data={data} keyrow = {i} choseCustomer={choseCustomer} cordinating={cordinating} choseCustomerCtrl={choseCustomerCtrl}/>;
    });
    return Routes;
  }
  render() {
