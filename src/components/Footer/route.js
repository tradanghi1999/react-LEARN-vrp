...
class Route extends React.Component {
  // onClickCustomer = ({keyrow,key}) => {

  //   this.props.choseCustomer({keyrow,key});
    // const {choseCustomer} = this.props;
    // ()=>choseCustomer({keyrow,key});
    // choseCustomer({keyrow,key});
    // debugger;
    // const { cusId } = data;
  ...
  render() {
    const { data, style ,keyrow,choseCustomer,cordinating,choseCustomerCtrl} = this.props;
    // console.log("this.props.choseCustomer",choseCustomer)
